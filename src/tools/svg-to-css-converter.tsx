...
const SvgToCssConverter: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-6">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-gray-400 mb-8">Convert SVG to CSS background</p>
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-yellow-400 to-amber-500 rounded-lg font-semibold hover:opacity-90 transition-all"
                    >
                        Process
                    </button>
