    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-6">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent">
                    Lorem Ipsum Generator
                </h1>
                <p className="text-gray-400 mb-8">Generate placeholder text for your designs</p>
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-gradient-to-r from-green-400 to-teal-500 rounded-lg font-semibold hover:opacity-90 transition-all"
                    >
                        Process
                    </button>
